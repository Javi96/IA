...
public class DataBase {
	...
	private void createApps() {
		...
		apps.add(new App("Amazon_Movil", (float) 0.00, "Compras"));
		apps.add(new App("Privalia", (float) 0.00, "Compras"));
		apps.add(new App("Stradivarius", (float) 0.00, "Compras"));
		apps.add(new App("Wallapop", (float) 0.00, "Compras"));
		apps.add(new App("ZaraHome_Shop_Online", (float) 0.00, "Compras"));
	}
	...
	private void createUsers() {
		...
		users.add(new User("Marta", 1992, 'f', "Germany"));
